...
function buildNameValue(ctx, fragment, topMarginForOuterGap, toolTipTextStyle) {
  ...
  var markerStr = noMarker ? '' : ctx.markupStyleCreator.makeTooltipMarker(fragment.markerType, fragment.markerColor || '#333', renderMode, fragment.opacity);
...
export function retrieveVisualOpacityForTooltipMarker(series, dataIndex) {
  var style = series.getData().getItemVisual(dataIndex, 'style');
...
var TooltipMarkupStyleCreator = /** @class */function () {
  ...
  TooltipMarkupStyleCreator.prototype.makeTooltipMarker = function (markerType, colorStr, renderMode, opacity) {
