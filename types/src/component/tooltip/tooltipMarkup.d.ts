...
export declare function retrieveVisualOpacityForTooltipMarker(series: SeriesModel, dataIndex: number): number;
...
export declare class TooltipMarkupStyleCreator {
    ...
    makeTooltipMarker(markerType: TooltipMarkerType, colorStr: ColorString, renderMode: TooltipRenderMode, opacity?: number): string;
    /**
     * @usage
     * ```ts
